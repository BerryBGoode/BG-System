...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new Controles_Personalizados.Calendario.Button();
        cmdTu = new Controles_Personalizados.Calendario.Button();
        cmdWe = new Controles_Personalizados.Calendario.Button();
        cmdTh = new Controles_Personalizados.Calendario.Button();
        cmdFr = new Controles_Personalizados.Calendario.Button();
        cmdSa = new Controles_Personalizados.Calendario.Button();
        cmdSu = new Controles_Personalizados.Calendario.Button();
        cmd1 = new Controles_Personalizados.Calendario.Button();
        cmd2 = new Controles_Personalizados.Calendario.Button();
        cmd3 = new Controles_Personalizados.Calendario.Button();
        cmd4 = new Controles_Personalizados.Calendario.Button();
        cmd5 = new Controles_Personalizados.Calendario.Button();
        cmd6 = new Controles_Personalizados.Calendario.Button();
        cmd7 = new Controles_Personalizados.Calendario.Button();
        cmd8 = new Controles_Personalizados.Calendario.Button();
        cmd9 = new Controles_Personalizados.Calendario.Button();
        cmd10 = new Controles_Personalizados.Calendario.Button();
        cmd11 = new Controles_Personalizados.Calendario.Button();
        cmd12 = new Controles_Personalizados.Calendario.Button();
        cmd13 = new Controles_Personalizados.Calendario.Button();
        cmd14 = new Controles_Personalizados.Calendario.Button();
        cmd15 = new Controles_Personalizados.Calendario.Button();
        cmd16 = new Controles_Personalizados.Calendario.Button();
        cmd17 = new Controles_Personalizados.Calendario.Button();
        cmd18 = new Controles_Personalizados.Calendario.Button();
        cmd19 = new Controles_Personalizados.Calendario.Button();
        cmd20 = new Controles_Personalizados.Calendario.Button();
        cmd21 = new Controles_Personalizados.Calendario.Button();
        cmd22 = new Controles_Personalizados.Calendario.Button();
        cmd23 = new Controles_Personalizados.Calendario.Button();
        cmd24 = new Controles_Personalizados.Calendario.Button();
        cmd25 = new Controles_Personalizados.Calendario.Button();
        cmd26 = new Controles_Personalizados.Calendario.Button();
        cmd27 = new Controles_Personalizados.Calendario.Button();
        cmd28 = new Controles_Personalizados.Calendario.Button();
        cmd29 = new Controles_Personalizados.Calendario.Button();
        cmd30 = new Controles_Personalizados.Calendario.Button();
        cmd31 = new Controles_Personalizados.Calendario.Button();
        cmd32 = new Controles_Personalizados.Calendario.Button();
        cmd33 = new Controles_Personalizados.Calendario.Button();
        cmd34 = new Controles_Personalizados.Calendario.Button();
        cmd35 = new Controles_Personalizados.Calendario.Button();
        cmd36 = new Controles_Personalizados.Calendario.Button();
        cmd37 = new Controles_Personalizados.Calendario.Button();
        cmd38 = new Controles_Personalizados.Calendario.Button();
        cmd39 = new Controles_Personalizados.Calendario.Button();
        cmd40 = new Controles_Personalizados.Calendario.Button();
        cmd41 = new Controles_Personalizados.Calendario.Button();
        cmd42 = new Controles_Personalizados.Calendario.Button();
    ...
    private Controles_Personalizados.Calendario.Button cmd1;
    private Controles_Personalizados.Calendario.Button cmd10;
    private Controles_Personalizados.Calendario.Button cmd11;
    private Controles_Personalizados.Calendario.Button cmd12;
    private Controles_Personalizados.Calendario.Button cmd13;
    private Controles_Personalizados.Calendario.Button cmd14;
    private Controles_Personalizados.Calendario.Button cmd15;
    private Controles_Personalizados.Calendario.Button cmd16;
    private Controles_Personalizados.Calendario.Button cmd17;
    private Controles_Personalizados.Calendario.Button cmd18;
    private Controles_Personalizados.Calendario.Button cmd19;
    private Controles_Personalizados.Calendario.Button cmd2;
    private Controles_Personalizados.Calendario.Button cmd20;
    private Controles_Personalizados.Calendario.Button cmd21;
    private Controles_Personalizados.Calendario.Button cmd22;
    private Controles_Personalizados.Calendario.Button cmd23;
    private Controles_Personalizados.Calendario.Button cmd24;
    private Controles_Personalizados.Calendario.Button cmd25;
    private Controles_Personalizados.Calendario.Button cmd26;
    private Controles_Personalizados.Calendario.Button cmd27;
    private Controles_Personalizados.Calendario.Button cmd28;
    private Controles_Personalizados.Calendario.Button cmd29;
    private Controles_Personalizados.Calendario.Button cmd3;
    private Controles_Personalizados.Calendario.Button cmd30;
    private Controles_Personalizados.Calendario.Button cmd31;
    private Controles_Personalizados.Calendario.Button cmd32;
    private Controles_Personalizados.Calendario.Button cmd33;
    private Controles_Personalizados.Calendario.Button cmd34;
    private Controles_Personalizados.Calendario.Button cmd35;
    private Controles_Personalizados.Calendario.Button cmd36;
    private Controles_Personalizados.Calendario.Button cmd37;
    private Controles_Personalizados.Calendario.Button cmd38;
    private Controles_Personalizados.Calendario.Button cmd39;
    private Controles_Personalizados.Calendario.Button cmd4;
    private Controles_Personalizados.Calendario.Button cmd40;
    private Controles_Personalizados.Calendario.Button cmd41;
    private Controles_Personalizados.Calendario.Button cmd42;
    private Controles_Personalizados.Calendario.Button cmd5;
    private Controles_Personalizados.Calendario.Button cmd6;
    private Controles_Personalizados.Calendario.Button cmd7;
    private Controles_Personalizados.Calendario.Button cmd8;
    private Controles_Personalizados.Calendario.Button cmd9;
    private Controles_Personalizados.Calendario.Button cmdFr;
    private Controles_Personalizados.Calendario.Button cmdMo;
    private Controles_Personalizados.Calendario.Button cmdSa;
    private Controles_Personalizados.Calendario.Button cmdSu;
    private Controles_Personalizados.Calendario.Button cmdTh;
    private Controles_Personalizados.Calendario.Button cmdTu;
