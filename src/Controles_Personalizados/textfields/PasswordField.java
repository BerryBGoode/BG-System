...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/Controles_Personalizados/textfields/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/Controles_Personalizados/textfields/eye_hide.png")).getImage();
