...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        setFont(new java.awt.Font("Roboto", 0, 18));
        setSelectionColor(new Color(80, 199, 255));
        iconSearch = new ImageIcon(getClass().getResource("/Controles_Personalizados/BarraBusqueda/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/Controles_Personalizados/BarraBusqueda/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/Controles_Personalizados/BarraBusqueda/loading.gif"));
